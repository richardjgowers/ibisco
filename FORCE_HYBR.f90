...
INTEGER :: I, J, K, M, L, hh, h,A,B,me,kt,vsite
...
!$OMP& SHARED(virt_masscoeff,VIRT_VS_IND)&
!$OMP& SHARED(NATOMS,NVIRTA,ITYPE,LIST,TYPE_LABEL,INBONDT,BOXXINV,BOXYINV,BOXZINV,BOXX,BOXY,BOXZ)&
...
!$OMP& PRIVATE(A,B,FXI,FYI,FZI,FXL,FYL,FZL,FXVL,FYVL,FZVL)&
