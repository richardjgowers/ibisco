...
DO I=1,NVIRTA
   read(10,*) VITYPE(I), INIT_NUMBCOMP(I), INDEX_VSITE(I)
...
DO I=1,NVIRTA
   ...
   ELSE !Else using a COM
      ...
      VIRTX(I) = SUMTOTX/MASS(VITYPE(I)) 
      VIRTY(I) = SUMTOTY/MASS(VITYPE(I)) 
      VIRTZ(I) = SUMTOTZ/MASS(VITYPE(I)) 
...
DO I=1,NVIRTA
   DO J=1,init_numbcomp(I)
      mass_coeff(I,J) = MASS(ITYPE(INDX_ATM(I,J)))/MASS(VITYPE(I))
   END DO
END DO
