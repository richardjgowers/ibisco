...
MODULE VAR
  ...
  REAL(KIND=RKIND), PARAMETER :: PI = 3.14159265358
  REAL(KIND=RKIND), PARAMETER :: MMOLY = 0.012D0
  REAL(KIND=RKIND) :: MASSSCALE, RSCALE, ESCALE, CONV
  REAL(KIND=RKIND) :: TEMPSCALE, PSCALE, TIMESCALE, FSCALE, DSCALE, VSCALE
  REAL(KIND=RKIND) :: D2R, R2D
  ...
  ! Neighbourlists
  REAL(KIND=RKIND) :: RLIST_ATOM, RCUT_ATOM, RCUTSQ_ATOM
  REAL(KIND=RKIND) :: RLIST_BEAD, RCUT_BEAD, RCUTSQ_BEAD
  INTEGER :: MAXNAB_ATOM
  INTEGER :: MAXNAB_BEAD
  ...
  REAL(KIND=RKIND) :: BOXX, BOXY, BOXZ, BOXXINV, BOXYINV, BOXZINV
  REAL(KIND=RKIND) :: BOXX2, BOXY2, BOXZ2
  REAL(KIND=RKIND) :: TOTMASS

  ! Thermostat variables
  REAL(KIND=RKIND) :: TEMP_IN, FAC
  REAL(KIND=RKIND) :: TEMP, TEMP_ATOM, TEMP_BEAD, TAUT
  REAL(KIND=RKIND) :: TEMP0, DT0, TAUT0, TAUP0, PRESSURE0, INITIME, DT
  REAL(KIND=RKIND) :: MKTEMP, MKTEMP_ATOM, MKTEMP_BEAD
  ! End thermostat variables

  !Barostat variables
  REAL(KIND=RKIND) :: PFAC, BETA, BETA0
  REAL(KIND=RKIND) :: TAUP, PRESSURE
  ...
  REAL(KIND=RKIND), POINTER :: RX(:), RY(:), RZ(:) ! unfolded coords
  ...
  REAL(KIND=RKIND), POINTER :: MASS(:), INVMASS(:), MASS0(:)
  REAL(KIND=RKIND), POINTER :: BINNB(:), BINB(:), BINA(:)
  REAL(KIND=RKIND), POINTER :: BINT(:), BINO(:)
