...
SUBROUTINE BONDED_FORCE()
  ...
  REAL*4 :: RXI, RYI, RZI
  REAL*4 :: FXI, FYI, FZI
  REAL*4 :: RXIJ, RYIJ, RZIJ, RIJSQ, RIJ
  REAL*4 :: RXKJ, RYKJ, RZKJ, RKJ
  REAL*4 :: RXJK, RYJK, RZJK, RJK, RXKL, RYKL, RZKL, RKL
  REAL*4 :: THETA, COSM, SINM, COTANM, COSN, SINN, COTANN, COST, SIGNT, PHI
  REAL*4 :: CT, eps = 1.0D-7, PHI_t
  REAL*4 :: RXM, RYM, RZM, RM, RXN, RYN, RZN, RN, RXS, RYS, RZS
  REAL*4 :: ALPHA, FIJ, VIJ, FIJK, VIJK, FIJKL, VIJKL
  REAL*4 :: FXIJ, FYIJ, FZIJ, FXIJK, FYIJK, FZIJK
  REAL*4 :: FX1, FY1, FZ1, FX4, FY4, FZ4, FX12, FY12, FZ12
  REAL*4 :: RXmN, RYmN, RZmN
  REAL*4, DIMENSION(NITEMS) :: FXL, FYL, FZL
#ifdef DETAILED_ATOM
